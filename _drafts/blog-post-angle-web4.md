...
- **Pre-web:** Human intermediaries did the work for you (travel agents, bank tellers). Conversational, personalized, expensive.
- **Web 2 / SaaS:** Self-service replaces humans. Cheaper, but *you* do the work now.
- **Web 4:** AI intermediaries do the work for you again — conversational and personalized, at software cost.
...
**The end of the SaaS era** doesn't mean all SaaS products disappear. It means the dominant paradigm for building and funding internet companies is shifting. The impact falls into three categories:
